(function (global, factory) {
    ...
    function normalizeSolution(solution, orientation, orientationOrder) {
        ...
        for (i = 0; i < clusters.length; ++i) {
         ...
         //clusters.sort(function(a, b) { return a.size - b.size; });
    ...
    function VennDiagram() {
        var width = 600,
            ...
            colourScheme = ["#EAEFFE", "#F6EAF0", "#9b832d", "#d62728", "#9467bd", "#8c564b", "#e377c2", "#7f7f7f", "#bcbd22", "#17becf"],
            colourIndex = 0,
    ...
    function sortAreas(div, relativeTo, sortAll) {
        ...
        div.selectAll("g").sort(function (a, b) {
            ...
            if (sortAll === false && a.sets.length !== b.sets.length) {
