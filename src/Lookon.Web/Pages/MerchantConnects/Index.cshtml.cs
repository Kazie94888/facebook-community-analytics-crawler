...
public class MerchantIntegrationModel : PageModel
{
    ...
    public                                   bool                             IsMaxSocialPage { get; set; }

    public MerchantIntegrationModel(IMerchantExtendAppService        merchantExtendAppService,
    ...
    public async Task OnGetAsync()
    {
        ...
        if (Merchant is not null)
        {
            ...
            MerchantStore        = await _merchantStoresExtendAppService.GetByMerchantAsync(Merchant.Id);
            IsMaxSocialPage      = Merchant.Communities.Count >= MerchantSubscription.SubscriptionConfig.MaxSocialPage;
        }
    }
}